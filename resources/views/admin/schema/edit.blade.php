...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Start Page Content -->
        <!-- ============================================================== -->
        <form action="{{ route('admin.schema.update', $schema->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="row">
                <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="{{ old('name', $schema->name) }}"
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        <label for="price">{{ translate('price') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="price" value="{{ old('price', $schema->price) }}"
                                            id="price" class="form-control" value="{{ old('price') }}" required>
                                        @error('price')
                                            <span class="error text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="currency"
                                            value="{{ old('currency', $schema->currency) }}" id="currency"
                                            class="form-control" value="{{ old('currency') }}" required>
                                        @error('currency')
                                            <span class="error text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="display" value="{{ old('display', $schema->display) }}"
                                            id="display" class="form-control">
                                        @error('display')
                                            <span class="error text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-3 col-xl-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="{{ $field }}" id="{{ $field }}"
                                                ...
                                                value="{{ old($field, data_get($schema, $field)) }}" />
                                                ...
                                                <div class="card card-primary section-box">
                                                    <div class="card-header">
                                                        <input type="checkbox" name="modules[]"
                                                            ...
                                                            @if (  data_get($schema , $key )== 1 ) checked
