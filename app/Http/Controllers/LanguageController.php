...
use function App\helper\auto_translator;
use function App\helper\getLanguageCode;
...
class LanguageController extends Controller
{
    ...
    {
        return view('user-views.business-settings.language.index');
    }

    public function index_app()
    {
        return view('user-views.business-settings.language.index-app');
    }
    ...
    public function update_status_new(Request $request)
    {
        // dd($request());
        $language = BusinessSetting::where('type', 'language')->first();
        $lang_array = [];
    ...
    {
        return view('user-views.business-settings.language.translate', compact('lang'));
    }
